...
def get_factory() -> StickyGiftFactory:
    activity = ba.getactivity()
    factory: StickyGiftFactory
    try:
        factory = activity.shared_sticky_gift_factory
    except AttributeError:
        factory = activity.shared_sticky_gift_factory = StickyGiftFactory()
    assert isinstance(factory, StickyGiftFactory)
    return factory
