...
current_locale = {
        ...
        'powerup_names': {
            'airstrikeBombs': 'Авиаудар',
            'cubeCompanion': 'Куб-компаньон',
            'curse': 'Проклятие',
            'elonMines': 'Мина Илона Маска',
            'healBombs': 'Лечебная бомба',
            'health': 'Аптечка',
            'highJump': 'Высокий прыжок',
            'holyBombs': 'Святая бомба',
            'iceBombs': 'Ледяные бомбы',
            'impactBombs': 'Ударные бомбы',
            'landMines': 'Мины',
            'luckyBlock': 'Блок удачи',
            'portalBombs': 'Портальная бомба',
            'punch': 'Боксерские перчатки',
            'shield': 'Энергетический щит',
            'speed': 'Ускорение',
            'stickyBombs': 'Бомбы-липучки',
            'stickyGiftBombs': 'Липучий привет',
