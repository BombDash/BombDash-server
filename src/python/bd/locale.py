...
current_locale = {
    ...
    'kick_admin_error': 'Ошибка: нельзя кикать админа',
    'not_player_error': 'Ошибка: игрока с таким ID нет на сервере.',
    'too_big_arg_error': 'Ошибка: слишком большое значение',
    ...
    'command_help_not_found': 'об этой команде ничего не известно :(',
    'command_help': {
        'help': 'помощь по команде/командам'},
    'command_some_error': 'Какая-то ошибка, сообщите об этом разработчикам',
    'commands_too_many': 'Слишком часто использовать эту команду нельзя! Подождите.',
}
